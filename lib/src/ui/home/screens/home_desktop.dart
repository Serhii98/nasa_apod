...
final class HomeDesktop extends BaseStatefulWidget {
  const HomeDesktop({super.key});

  @override
  State<HomeDesktop> createState() => HomeDesktopState();
}

final class HomeDesktopState
    extends BaseStatefulScreen<HomeDesktop, HomeBlocState, HomeBloc> {
  @override
  HomeBloc createBloc() {
